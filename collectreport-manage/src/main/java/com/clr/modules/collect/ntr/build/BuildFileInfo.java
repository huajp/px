package com.clr.modules.collect.ntr.build;

import com.clr.modules.collect.ntr.entity.system.FileInfo;
import com.clr.modules.collect.ntr.entity.system.FileName;
import com.clr.common.utils.DateUtils;
import com.clr.common.utils.StringUtils;
...
public class BuildFileInfo {
    ...
    public static String getFileName(FileInfo f){
        ...
        //文件生成日期 15-22 YYYYMMDD
        String fileCreateDate =DateUtils.date2String(FileName.文件生成日期格式.getValue(),f.getDate());
    ...
    public static String getFileHead(FileInfo f){
        ...
        sb.append(f.getFinanCode());
        String fileCreateDate =DateUtils.date2String(FileName.文件生成时间格式.getValue(),f.getDate());
        sb.append(fileCreateDate);
