...
import com.clr.exception.RRException;
...
public class GenUtils {
	...
	public static List<String> getTemplates() {
		...
		templates.add("template/po.java.btl");
		templates.add("template/Dao.java.btl");
		templates.add("template/Dao.xml.btl");
		templates.add("template/BizService.java.btl");
		templates.add("template/BizServiceImpl.java.btl");
		return templates;
	}
	 ...
	 * 生成代码
	 */
	public static void generatorCode(TablePO table, List<ColumnPO> columns, GeneratorParamEntity params,
									 ZipOutputStream zip) {
	...
	public static void main(String[] args) {
		System.out.println(tableToJava("t_meun","t_"));
	}
